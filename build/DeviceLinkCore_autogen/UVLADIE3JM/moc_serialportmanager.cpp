...
template <> constexpr inline auto SerialPortManager::qt_create_metaobjectdata<qt_meta_tag_ZN17SerialPortManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'rawBytesReceived'
        QtMocHelpers::SignalData<void(const QByteArray &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QByteArray, 3 },
        }}),
        // Signal 'frameReceived'
        QtMocHelpers::SignalData<void(const ParsedFrame &)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Signal 'logMessage'
...
void SerialPortManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->rawBytesReceived((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->frameReceived((*reinterpret_cast<std::add_pointer_t<ParsedFrame>>(_a[1]))); break;
        case 2: _t->logMessage((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->portError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SerialPortManager::*)(const QByteArray & )>(_a, &SerialPortManager::rawBytesReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialPortManager::*)(const ParsedFrame & )>(_a, &SerialPortManager::frameReceived, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialPortManager::*)(const QString & )>(_a, &SerialPortManager::logMessage, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialPortManager::*)(const QString & )>(_a, &SerialPortManager::portError, 3))
            return;
    }
}
...
// SIGNAL 0
void SerialPortManager::rawBytesReceived(const QByteArray & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void SerialPortManager::frameReceived(const ParsedFrame & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void SerialPortManager::logMessage(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void SerialPortManager::portError(const QString & _t1)
{
